...
// #for doses
    cy.visit("http://localhost:8100/members/vaccine/2/doses/add");
  ...
  cy.visit("http://localhost:8100/members/vaccine");
  cy.get('#brands2').click();
  cy.wait(3000);
  cy.pause(); // Pause the test execution for debugging
  // cy.get('#add1').click({ force: true });
  cy.visit("http://localhost:8100/members/vaccine/2/brands/add");
  ...
  // Click on the edit button
    cy.get('#brande3').click();
    
    cy.get('body').click();
    cy.get('#brandu').type("2");
    cy.get('body').click();
    cy.wait(3000);
    cy.get('#brandss').click();
    cy.get('#brandd3').click();
    cy.wait(3000);
...
//     cy.get('ion-datetime').click();
  ...
  it('should change the date of single date', () => {
    cy.visit('http://localhost:8100/members/schedule');
    cy.wait(5000);
